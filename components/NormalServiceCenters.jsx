...
const NormalServiceCenters = ({route, navigation})=>{
    ...
    useEffect(()=>{
        ...
        console.log(route.params.rangeRadius)
        serverCall()
                ...
                <View style={styles.container4}>
                    
                    {
                        servicCenters.map((data, index)=>{
                            ...
                            console.log(index)
                             return(
                                <ServiceCentersCard key={index} sc_id={data.sc_id} serviceName={serviceType} name={data.name} city={data.city} price={data.price} vehicleId={vehicleId}   navigation={navigation}></ServiceCentersCard>
                             )                  
...
const ServiceCentersCard = (props)=>{
    return(
        <View style = {styles.container}>
            ...
            <TouchableOpacity style={styles.viewDetButton} onPress={()=>{props.navigation.navigate('SetDateTime',{sc_id:props.sc_id,serviceName:props.serviceName,vehicleId:props.vehicleId,mainType:"Normal"})}} >
...
export default NormalServiceCenters;